            ...
            <div class="panel panel-info">
                ...
                @if (count($errors) > 0)
                    ...
                    <div class="panel-body">
                        <form action="{{route('admin.pays.add')}}" id="frmPays" method="post" enctype="multipart/form-data"  >
                        {{ csrf_field()}}
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Tên phương thức thanh toán</label>
                                    <input name="name" class="form-control" type="text" placeholder="Nhập tên danh mục hoa..." >
                                    <p class="help-block"></p>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Hướng dẫn thanh toán</label>
                                <textarea class="form-control" rows="3" name="document"></textarea>
