...
<?php
	...
	$address = $arUser->message;

?>
<form method="post" action="{{route('public.pay.payConfirm_guest',$id)}}">
{{csrf_field()}}
			<div class="left_content cthongtin">
				...
				<div class="title">
					...
					</span> Thông tin thanh toán của {{$fullname}}
				</div>
				...
				<div class="feat_prod_box_details">
			       ...
			       @foreach($arPayments as $key =>$value)
